...
from utils import seq2mat, substitute_duplicates, t, trace
...
try:
    ...
    for length in range(1, 8):
        ...
        for seq in product(clifford_gates, repeat=length):
            seqstr = substitute_duplicates("".join(seq), duplicates)
...
for length in range(1, 16):
    ...
    for (mat1, seq1), (mat2, seq2) in product(
        ...
        seqstr = substitute_duplicates(seq1 + "t" + seq2, duplicates)
        if seqstr in sequences:
            continue
        matrix = mat1 @ mat2
